...
void testDeveloping()
{
	...
	math::Identity<double> FI1(N);
	//std::cout << "funtion FI1 : " << FI1(3) << "\n";

	
	math::Square<double> FS1(N);
	double FS1_val = 0.0;
	try
	{
		FS1_val = FS1(3);
	...
	math::Set<double> N2(1.0,20.0,1.0);
	math::Identity<double> FI2(N2);
	math::Constant<double> FC2(N2,2);
	math::Sum<double> FSum1(FI2,FC2);
	...
	math::Coordenadas<double> FCOOF(coorF);
	math::Coordenadas<double> FCOOG(coorG);
	math::Composition<double> FCOMP1(FCOOF,FCOOG);
	double FCOMP1_x = 3.0;
